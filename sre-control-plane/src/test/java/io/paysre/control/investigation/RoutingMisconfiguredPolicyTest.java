...
class RoutingMisconfiguredPolicyTest {

    @Test
    void allowsNoRunbooksAndStillRequiresHumanReview() {
        var policy = new RoutingMisconfiguredPolicy();

        assertThat(policy.rootCause()).isEqualTo(RootCauseCode.ROUTING_MISCONFIGURED);
